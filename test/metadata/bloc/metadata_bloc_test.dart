...
void main() {
  group('Metadata Bloc Unit Test', () {
    late MetadataRepository mockedRepository;
    late BehaviorSubject<bool> measurement;
    late Image mockedImage;
    ...
    group('metadata events', () {
      blocTest(
        'started event',
        build: () => MetadataBloc(),
        act: (MetadataBloc bloc) => bloc.add(startedEvent),
      ...
      blocTest(
        ...
        skip: 0,
        build: () => MetadataBloc(),
        act: (MetadataBloc bloc) => bloc.add(MetadataBackgroundEvent(mockedImage, Size(300, 400))),
        verify: (MetadataBloc bloc) async {
      ...
      blocTest(
        'delete region event',
        build: () => MetadataBloc(),
        act: (MetadataBloc bloc) => bloc.add(MetadataDeleteRegionEvent(Offset(10, 10), Size(10, 10))),
        verify: (MetadataBloc bloc) async {
