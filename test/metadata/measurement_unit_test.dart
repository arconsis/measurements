  ...
  group('Testing measurement conversions', () {
    group('Testing conversions from meter to others', () {
      ...
      test('meter to millimeter', () {
        expect(meter.convertToMillimeter().value, equals(1000));
      });
      ...
      test('meter to meter', () {
        expect(meter.convertToMeter().value, equals(1));
      });
    });
    ...
    group('Testing conversions from millimeter to others', () {
      ...
      test('millimeter to meter', () {
        expect(millimeter.convertToMeter().value, equals(0.001));
      });
      ...
      test('millimeter to millimeter', () {
        expect(millimeter.convertToMillimeter().value, equals(1));
      });
    });
    ...
    group('Testing conversions from inch to others', () {
      ...
      test('inch to meter', () {
        expect(inch.convertToMeter().value, equals(0.0254));
      });

      test('inch to millimeter', () {
        expect(inch.convertToMillimeter().value, equals(25.4));
      });
      ...
      test('inch to inch', () {
        expect(inch.convertToInch().value, equals(1));
      });
    });
    ...
    group('Testing conversions from foot to others', () {
      ...
      test('foot to meter', () {
        expect(foot.convertToMeter().value, equals(0.3048));
      });

      test('foot to millimeter', () {
        expect(foot.convertToMillimeter().value, equals(304.8));
      });

      test('foot to inch', () {
        expect(foot.convertToInch().value, equals(12));
      });

      test('foot to foot', () {
        expect(foot.convertToFoot().value, equals(1));
      });
    });
  });
}
